...
if (isset($_POST['submit'])) {
    ...
    if($_FILES['gambar']['error'] == 4) {
        ...
        redirectTo('admin/slideGame/tambah.php');
    } else {
        $gambar = upload('gambar', ['jpg', 'png', 'jpeg', 'pdf', 'webp'], 500, '../../assets/uploads/slideGame/');
    }

    $query = "INSERT INTO slide_game VALUES (null, '$nama_game', '$deskripsi', '$tombol', '$urutan', '$gambar')";
...
<div class="card shadow p-3">
    ...
    <form action="" method="post" id="form" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                        <div class="mb-3">
                            <label for="nama_game" class="form-label">Nama Game <span class="text-danger">*</span></label>
        ...
        <a class="btn btn-warning" href="<?= $base_url; ?>admin/slideGame" role="button">Cancel</a>
